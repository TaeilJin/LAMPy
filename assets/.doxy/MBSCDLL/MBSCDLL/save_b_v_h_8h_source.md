...
[**File List**](files.md) **>** [**MBS\_CDLL**](dir_ddc84d54b9d1cd5babbd6fb469a13a43.md) **>** [**saveBVH.h**](save_b_v_h_8h.md)

[Go to the documentation of this file](save_b_v_h_8h.md)
...
public:
    ...
    */
    ...
    int saveBVHFile(gMultibodySystem* character, const char* filename, arma::mat Quat_Motion, mgBone::_AXISORDER axisorder, float frametime = 1.0f / 60.0f, float scale = 1.0f) {
